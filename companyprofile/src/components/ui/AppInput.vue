...
<template>
  <label class="block">
    ...
    <input
      ...
      :disabled="disabled"
      class="h-11 w-full rounded-xl bg-white px-3 text-slate-900 shadow-md ring-1 ring-slate-200/70 transition duration-300 ease-in-out placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#099044]/25"
      :class="[
