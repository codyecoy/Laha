    ...
    children: [
      {
        ...
        component: HomeView,
        meta: {
          title: 'Sahabat Anak • Perlindungan & Advokasi',
          description:
      ...
      },
      {
        ...
        name: 'about',
        component: AboutView,
        meta: { title: 'Tentang Kami • Sahabat Anak', description: 'Visi, misi, sejarah, dan tim lembaga.' },
      },
      {
        path: 'layanan',
        name: 'services',
        component: ServicesView,
        meta: { title: 'Layanan • Sahabat Anak', description: 'Pendampingan hukum, konseling, edukasi, dan hotline.' },
      },
      {
        path: 'artikel',
        name: 'articles',
        ...
        meta: {
          title: 'Artikel & Edukasi • Sahabat Anak',
      ...
      },
      {
        ...
        meta: { title: 'Artikel • Sahabat Anak', description: 'Detail artikel edukasi perlindungan anak.' },
      },
      {
        path: 'galeri',
        name: 'gallery',
        component: GalleryView,
        meta: { title: 'Galeri Kegiatan • Sahabat Anak', description: 'Dokumentasi kegiatan advokasi, edukasi, dan kampanye.' },
      },
      {
        path: 'donasi',
        name: 'donate',
        component: DonateView,
        meta: { title: 'Donasi • Sahabat Anak', description: 'Dukung pendampingan, edukasi, dan layanan hotline.' },
      },
      {
        path: 'kontak',
        name: 'contact',
        component: ContactView,
        meta: { title: 'Kontak • Sahabat Anak', description: 'Hubungi kami, hotline, dan lokasi.' },
      },
      {
        path: 'lapor',
        name: 'report',
        component: ReportCaseView,
        meta: { title: 'Laporan Kasus • Sahabat Anak', description: 'Form pelaporan kasus perlindungan anak (bisa anonim).' },
      },
    ],
  },
  {
    ...
    meta: { title: 'Login Admin • Sahabat Anak', description: 'Akses admin panel.' },
  },
  {
    path: '/admin',
    component: AdminLayout,
    meta: { requiresAuth: true, title: 'Admin • Sahabat Anak', description: 'Admin panel.' },
    children: [
